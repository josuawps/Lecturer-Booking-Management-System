...
<head>
    ...
    <title>Dosen Appointment Management System in PHP</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-secondary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="dashboard.php">
                ...
                <div class="sidebar-brand-text mx-3">DelSchedule</div>
            </a>
            ...
            ?>
            <li class="nav-item">
                <a class="nav-link" href="dosen_schedule.php">
                    <i class="fas fa-user-clock"></i>
                    <span>Lecturer Schedule</span></a>
            </li>
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        if($_SESSION['type'] == 'Dosen')
                        {
                            ...
                            foreach($user_result as $row)
                            {
                                $user_name = $row['dosen_name'];
                                $user_profile_image = $row['dosen_profile_image'];
                            }
                        }
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                aria-labelledby="userDropdown">
                                <a class="dropdown-item" href="dosen_profile.php">
                                    <i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>
                                    Profile
                                </a>
                                <div class="dropdown-divider"></div>
